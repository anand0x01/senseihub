  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-7 center-block">
        <form action="{{ URL::route('add_non_profit') }}" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
          {{ Form::token() }}
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-4 control-label">Category</label>
              <div class="col-sm-8">
                <p class="form-control-static">Non-Profit <a href="{{ URL::route('add_new') }}"><small>(change)</small></a></p>
              </div>
            </div>
            <div class="form-group">
