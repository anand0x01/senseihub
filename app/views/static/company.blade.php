...
<div class="container">
    <div class="row">
        <div class="col-xs-6  custom_form center-block">
            <form method="post" action="{{ URL::route('static_reg_comp') }}" class="form-horizontal">
                {{ Form::token() }}
              <fieldset>
                <div class="form-group">
                  <label for="inputUserName" class="col-lg-2 control-label">Company Name</label>
                  <div class="col-lg-10">
                  {{ Form::text('inputUserName', Input::old('inputUserName'), array('class' => 'form-control', 'required' => 'required', 'autocomplete' => 'off' , 'placeholder' => 'Company')) }}
